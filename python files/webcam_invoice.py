# -*- coding: utf-8 -*-
"""Webcam_invoice (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1zuvz0b6Hd0k2Qtzvya3UZMP6NhKbWoul
"""
...
def convertWebcam():
    ...
    while True:
        try:
            ...
            key = cv2.waitKey(1)
            if key == ord('s'): 
                cv2.imwrite(filename='invoice_image.jpg', img=frame)
                webcam.release()
                img_new = cv2.imread('invoice_image.jpg', cv2.IMREAD_GRAYSCALE)
